...
<div class="container-fluid py-5 px-md-5 animated-fade-in">
    <div class="row">
        ...
        <div class="col-lg-3 mb-4">
            <div class="card card-custom p-3 border-0 shadow-sm" style="background-color: var(--card-bg);">
                ...
                <div class="nav flex-column gap-1 small">
                    ...
                    <a href="{{ route('admin.brands.index') }}" class="admin-nav-link active"><i class="fa-solid fa-copyright me-2"></i>Brands</a>
        ...
        <!-- Main Content -->
        <div class="col-lg-9">
            <h3 class="fw-bold mb-4 text-dark"><i class="fa-solid fa-registered me-2 text-primary"></i>Vehicle Brands</h3>

            <div class="row g-4">
                <!-- Left: Create Brand Form -->
                <div class="col-md-4">
                    <div class="card card-custom p-4 border-0 shadow-sm" style="background-color: var(--card-bg);">
                        <h5 class="fw-bold mb-3">Create Brand</h5>
                        <form action="{{ route('admin.brands.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-4">
                                <label class="form-label small fw-semibold text-muted">Brand Name</label>
                                <input type="text" name="name" class="form-control border-secondary-subtle" placeholder="e.g. Porsche" required>
                            </div>
                                ...
                                <tbody>
                                    @forelse($brands as $brand)
                                        <tr>
                                            ...
                                            <td><code class="small">{{ $brand->slug }}</code></td>
                                            <td class="text-end">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center text-muted small py-4">No brands created yet.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
